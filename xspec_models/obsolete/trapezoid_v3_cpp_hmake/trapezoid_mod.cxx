                             ...
                             int spectrumNumber, RealArray& flux, RealArray& fluxError)
{
    ...
    if (params.size() < 4)
    {
        throw RedAlert("trapezoidmod: Insufficient parameters, expected 4.");
    }
    ...
    flux.resize(Nflux);
    fluxError.resize(Nflux, 0.0); // セグフォ回避のためゼロで初期化
