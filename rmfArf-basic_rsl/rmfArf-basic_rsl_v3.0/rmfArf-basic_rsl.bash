...
# 2024.06.24 v2.5 by Yuma Aoki (Kindai Univ.)
#   arfのenergy rangeを変数で設定(引数ではない)できるようにし、デフォルト値を0.3–30.0 keVに設定。
#   arfのnum_photonを1000000に設定
# 2024.11.07 v2.6 by Yuma Aoki (Kindai Univ.)
#   logfileに環境変数'HEADAS','CALDB'を出力する仕様に変更
# 2025.02.24 v3.0 Yuma Aoki (Kindai Univ.)
